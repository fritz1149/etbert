...
@click.command()
@click.option('--_category', type=int)
@click.option('--dataset_dir')
@click.option('--pcap_path')
@click.option('--dataset_save_path')
@click.option('--samples', type=int)
@click.option('--dataset_level')
@click.option('--open_dataset_not_pcap', type=int)
@click.option('--file2dir', type=int)
@click.option('--splitcap_finish', type=int)
@click.argument('features', nargs=-1, type=str)
def main(_category, dataset_dir, pcap_path, dataset_save_path, samples, features, dataset_level,
